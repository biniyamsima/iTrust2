...
public class APIVaccineVisitTest {
    ...
    public void testVisitRequestAPI () throws Exception {
        ...
        final CPTCodeForm cptCode1 = new CPTCodeForm();
        cptCode1.setCode( "10175" );
        cptCode1.setCost( 55.0 );
        cptCode1.setDescription( "30-45 minutes" );
        cptCodeService.save( cptCodeService.build(cptCode1) );
        final List<CPTCodeForm> cpts = new ArrayList<CPTCodeForm>();
        cpts.add( cptCode1 );
        vaccineVisitForm.setCPTCodeList( cpts );
    ...
    public void testVisitRequestAPIDelete () throws Exception {
        ...
        final List<CPTCodeForm> cpts = new ArrayList<CPTCodeForm>();
        cpts.add( cptCode1 );
        appointmentForm.setCPTCodeList( cpts );
