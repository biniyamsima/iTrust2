...
public class VaccineVisit extends DomainObject {
    ...
    /**
     * List of CPTCodes assigned to the vaccine visit.
     */
    ...
    /**
     * Setter method for setting list of cpt codes
     * @param CPTList 
     * 			List of CPT Codes for this vaccine visit.
     */
    public void setCPTList( List<CPTCode> CPTList ) {
    	this.CPTCodeList = CPTList;
    }
    
    /**
     * Getter method for the list of cpt codes.
     * @return the list of cpt codes for this visit.
     */
    public List<CPTCode> getCPTList(){
