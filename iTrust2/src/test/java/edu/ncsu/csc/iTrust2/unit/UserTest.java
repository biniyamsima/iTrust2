...
public class UserTest {
    ...
    public void testUserRoles () {
        ...
        final User user4 = new Personnel( new UserForm( USER_4, PW, Role.ROLE_BILLING, 1 ) );

        service.save( user4 );

        Assert.assertEquals( "Ensure that the billing user is added to the database", 4, service.count() );
    }

    /**
     * Tests illegal role combinations for the Admin user.
     */
    @Test
    @Transactional
    ...
    /**
     * Tests illegal role combinations for the Patient user.
     */
    @Test
    @Transactional
    public void testPatientUser () {
        try {
            final UserForm uf = new UserForm( USER_2, PW, Role.ROLE_PATIENT, 1 );
            uf.addRole( Role.ROLE_LABTECH.toString() );

            final User user2 = new Patient( uf );

            // Otherwise we get compilation warnings
            Assert.assertNotNull( user2 );

            Assert.fail( "It should not be possible to create a Patient with a secondary role!" );
        }
        catch ( final Exception e ) {
            // expected
        }
        ...
        try {
            ...
            Assert.fail( "It should not be possible to add another Role to a Patient user!" );
        }
        catch ( final Exception e ) {
            // expected
        }
        ...
        try {
            ...
            user2.addRole( Role.ROLE_PATIENT );

            Assert.fail( "It should not be possible to add the Patient role to any user!" );
        }
        catch ( final Exception e ) {
            // expected
        }
    ...
    /**
     * Tests illegal role combinations for the Billing user.
     */
    @Test
    @Transactional
    public void testBillingUser () {
        try {
            final UserForm uf = new UserForm( USER_2, PW, Role.ROLE_BILLING, 1 );
            uf.addRole( Role.ROLE_LABTECH.toString() );
            ...
            Assert.fail( "It should not be possible to create a Billing user with a secondary role!" );
        }
        catch ( final Exception e ) {
            // expected
        }
        ...
        try {
            ...
            Assert.fail( "It should not be possible to add another Role to a Billing user!" );
        }
        catch ( final Exception e ) {
            // expected
        }
        ...
        try {
            ...
            Assert.fail( "It should not be possible to add the Billing role to any user!" );
        }
        catch ( final Exception e ) {
            // expected
        }
