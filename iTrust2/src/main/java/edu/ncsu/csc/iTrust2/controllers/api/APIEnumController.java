 ...
 *
 * @author Kai Presler-Marshall, Lauren Murillo
 */
@RestController
public class APIEnumController extends APIController {
    ...
    /**
     * Gets vaccination statuses
     *
     * @return vaccination statuses
     */
    @GetMapping ( BASE_PATH + "/vaccinationstatus" )
    public List<VaccinationStatus> getVaccinationStatuses () {
        return Arrays.asList( VaccinationStatus.values() );
    }
    ...
    @GetMapping ( BASE_PATH + "/billstatuses" )
    public List<BillStatus> getBillStatuses () {
        final List<BillStatus> ret = Arrays.asList( BillStatus.values() ).subList( 0, BillStatus.values().length );
        return ret;
    }

    @GetMapping ( BASE_PATH + "/paymentmethods" )
    public List<PaymentMethod> getPaymentMethods () {
        final List<PaymentMethod> ret = Arrays.asList( PaymentMethod.values() ).subList( 0,
