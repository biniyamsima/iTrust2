...
public class APIUserController extends APIController {
    ...
    /** Constant for billing user role */
    ...
    private static final List<String> ALL_ROLES       = List.of( ROLE_ADMIN, ROLE_PATIENT, ROLE_HCP, ROLE_ER,
            ROLE_LABTECH, ROLE_VIROLOGIST, ROLE_OD, ROLE_OPH, ROLE_VACCINATOR, ROLE_BILLING );
    ...
    public ResponseEntity generateUsers () {
        ...
        final User biller = new Personnel( new UserForm( "biller", "123456", Role.ROLE_BILLING, 1 ) );

        userService.save( patient );

        userService.save( vaccinator );

        userService.save( biller );
