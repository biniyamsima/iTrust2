...
public class OfficeVisit extends DomainObject {
    ...
    /**
     * Setter for setting a list of CPT codes to the office visit.
     *
     * @param cptCodeList
     *            The new list of CPT codes
     */
    public void setCPTCodeList ( final List<CPTCode> cptCodeList ) {
        this.CPTCodeList = cptCodeList;
    }

    /**
     * Getter for getting the list of CPTCodes for the office visit.
     *
     * @return the list of cpt codes
     */
    public List<CPTCode> getCPTCodeList () {
        if ( CPTCodeList == null ) {
            CPTCodeList = new ArrayList<CPTCode>();
        }
