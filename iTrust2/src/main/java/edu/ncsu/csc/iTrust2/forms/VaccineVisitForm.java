...
public class VaccineVisitForm implements Serializable {
    ...
    /** List of cpt codes assigned to this visit */
    private List<CPTCodeForm> CPTCodeList;
    ...
    public VaccineVisitForm ( final VaccineVisit ov ) {
        ...
        setCPTCodeList( new ArrayList<CPTCodeForm>() );
    }
    ...
    /**
     * Setter for setting list of cpt codes.
     * @param CPTList
     * 			The list of cpt codes
     */
    public void setCPTCodeList( List<CPTCodeForm> CPTList ) {
    	this.CPTCodeList = CPTList;
    }
    
    /**
     * Getter for getting the list of cpt codes
     * @return a list of cpt codes
     */
    public List<CPTCodeForm> getCPTCodeList(){
