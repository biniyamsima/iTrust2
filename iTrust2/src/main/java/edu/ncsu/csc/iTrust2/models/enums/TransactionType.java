...
public enum TransactionType {
    ...
    /**
     * The billing user adds a new CPTCode to the system.
     */
    CPT_CREATE ( 2000, "Billing user has added a new CPT Code", false ),

    /**
     * The billing user edits a CPTCode in the system.
     */
    CPT_EDIT ( 2001, "Billing user has edited an existing CPT Code", false ),

    /**
     * The billing user removes a CPTCode from the system.
     */
    CPT_REMOVE ( 2002, "Billing user has removed a CPT Code", false ),

    /**
     * The current user view the list of CPTCodes in the system.
     */
    CPT_VIEW ( 2003, "User viewed CPT Code", false ),

    /**
     * The set of default CPT Codes was generated.
     */
    CPT_DEFAULT ( 2004, "List of default CPT Codes generated", false ),

    /**
     * The patient user views their bills
     */
    PATIENT_VIEW_BILLS ( 2200, "Patient viewed bills", true ),

    /**
     * The billing user views the bills in the system
     */
    BILLING_VIEW_BILLS ( 2201, "Billing user viewed bills", false ),

    /**
     * The patient user download a bill
     */
    PATIENT_BILL_DOWNLOAD ( 2210, "Patient has downloaded a bill", true ),

    /**
     * The billing user download a bill
     */
    BILLING_BILL_DOWNLOAD ( 2211, "Billing user has downloaded bill", false ),

    /**
     * The billing user adds a payment to a bill.
     */
    BILLING_ADD_PAYMENT ( 2300, "Billing user added payment information", false ),

    /**
     * The billing user edits a payment to a bill.
     */
    BILLING_EDIT_PAYMENT ( 2301, "Billing user edited payment information", false );
