...
public class OfficeVisitForm implements Serializable {
    ...
    /** List of CPTCodes assigned to the office visit. */
    private List<CPTCode>          CPTCodeList;           // was <CPTCodeForm
    ...
    public OfficeVisitForm ( final OfficeVisit ov ) {
        ...
        setCPTCodeList( ov.getCPTCodeList() );
    }
    ...
    /**
     * Setter for setting the the list of CPTcodes for the office visit
     *
     * @param CPTcodes
     *            List of cpt codes
     */
    public void setCPTCodeList ( final List<CPTCode> CPTcodes ) { // was
                                                                  // cptcodeform
        this.CPTCodeList = CPTcodes;
    }

    /**
     * Getter for getting the CPT code list.
     *
     * @return a list of CPT codes
     */
    public List<CPTCode> getCPTCodeList () { // was cptcodeform
        return this.CPTCodeList;
    }
